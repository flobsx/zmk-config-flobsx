...
box_line "  ${GREEN}make copy${RESET}        flash both halves (interactive)"
box_line "  ${GREEN}make copy-left${RESET}   flash left half only"
box_line "  ${GREEN}make copy-right${RESET}  flash right half only"
box_bottom
...
echo "  5. make copy         # or: make copy-left / make copy-right"
